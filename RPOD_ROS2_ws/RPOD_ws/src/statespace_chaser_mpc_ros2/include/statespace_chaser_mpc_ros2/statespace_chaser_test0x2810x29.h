...
/* Live CV-measured target tumble/rotation angle (radians). Write this
 * before every step; see definition site in
 * statespace_chaser_test0x2810x29.c for details. */
extern real_T rtP_TargetTumbleAngle;

/* Mission parameters: approach-distance schedule + docking-point
 * geometry. See definition site for defaults/units. */
extern real_T rtP_ApproachHoldRadius;
extern real_T rtP_ApproachFinalRadius;
extern real_T rtP_ApproachRampStartTime;
extern real_T rtP_ApproachRampEndTime;
extern real_T rtP_DockCenterX;
extern real_T rtP_DockCenterY;
extern real_T rtP_DockArmOffset;
